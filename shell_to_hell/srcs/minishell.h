...
char	*split_tokens_simples(int *flags, char *txt, int *i, int *d);
char	*split_tokens_doubles(int *flags, char *txt, int *i, int *d);
...
char	**get_lines(char *txt, int *count, int *flags);
