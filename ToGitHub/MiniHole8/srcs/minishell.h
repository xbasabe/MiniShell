...
void		handler_signal_zeta(int sig);
void		sig_int(int code);
void		sig_quit(int code);
void		sig_init(void);
void		handler_control_c(int sig);
void		handler_control_d(int sig);
...
//redirect chain
void		redir_stack(t_stack *stack);
void		redir_token(t_stack *stack);
